...
$GOOGLE_RECAPTHCA_V_3_SECRET_KEY = "6Lc1_dspAAAAAGCnpYx9uo-dSBV_j9Yejubs5YP6";
...
if ($decoded_response && $decoded_response->score > 0.5) {
  try {
    ...
    $mail->Password   = 'Fdy5vmv2'; // Пароль на почте
    $mail->SMTPSecure = 'ssl';
    $mail->Port       = 465;

    $mail->setFrom('zakaz@sks.msk.ru', 'Заявка с сайта sks.msk.ru'); // Адрес самой почты и имя отправителя

    // Получатель письма
    $mail->addAddress('yuriybevov@gmail.com','jury19y@mail.ru', 'zakaz@sks.msk.ru');
