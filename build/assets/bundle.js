...
/***/ "./src/scripts/modules/anchor-links.js":
/*!*********************************************!*\
  !*** ./src/scripts/modules/anchor-links.js ***!
  \*********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
if (anchors) {
  var onClickScrollToAnchor = function onClickScrollToAnchor(evt) {
    evt.preventDefault();
    var anchor = evt.currentTarget.getAttribute('href');
    var headerOffset = document.querySelector('.header').getBoundingClientRect().height;
    var target = document.querySelector(anchor);
    var offset = target.offsetTop - headerOffset;
...
/***/ "./src/scripts/modules/form-submit.js":
/*!********************************************!*\
  !*** ./src/scripts/modules/form-submit.js ***!
  \********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _form_validation__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./form-validation */ "./src/scripts/modules/form-validation.js");

var btns = document.querySelectorAll('[type="submit"]');
...
/* harmony export */ });
/* harmony import */ var _send_form__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./send-form */ "./src/scripts/modules/send-form.js");

var formValidation = function formValidation(form) {
  var fields = form.querySelectorAll("[data-required]");

  var setInvalidStatus = function setInvalidStatus(field) {
    !field.classList.contains('invalid') ? field.classList.add('invalid') : null;
  ...
  var setValidStatus = function setValidStatus(field) {
    field.classList.contains('invalid') ? field.classList.remove('invalid') : null;
  };
  ...
  var isInvalid = document.querySelector('.invalid');

  if (!isInvalid) {
    (0,_send_form__WEBPACK_IMPORTED_MODULE_0__.sendForm)(form);
  }
};
...
if (opener) {
  ...
  var tl = gsap__WEBPACK_IMPORTED_MODULE_2__.gsap.timeline().pause();
  tl.fromTo(nav, {
    display: 'none',
    opacity: 0
  }, {
...
function sendForm(form) {
  ...
  function success() {
    hideLoader();
    form.reset();
    var currentModal = form.closest(".modal");
    new _classes_Modal__WEBPACK_IMPORTED_MODULE_0__.Modal(currentModal).refresh();
    setTimeout(function () {
...
/***/ "./src/scripts/utils/bodyLocker.js":
/*!*****************************************!*\
  !*** ./src/scripts/utils/bodyLocker.js ***!
  \*****************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./src/scripts/utils/focusTrap.js":
/*!****************************************!*\
  !*** ./src/scripts/utils/focusTrap.js ***!
  \****************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _modules_modal_init_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modules/modal-init.js */ "./src/scripts/modules/modal-init.js");
/* harmony import */ var _modules_input_number_mask_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/input-number-mask.js */ "./src/scripts/modules/input-number-mask.js");
...
/* harmony import */ var _modules_anchor_links_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/anchor-links.js */ "./src/scripts/modules/anchor-links.js");
